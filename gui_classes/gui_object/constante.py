...
# --- Styles disponibles ---
dico_styles = {
    "clay": "A fun, colorful portrait of a person entirely made from bright modeling clay, similar to children's plasticine, with soft, rounded, playful shapes and smooth, shiny surfaces. Facial features are exaggerated and cartoonish, with vivid, saturated colors like red, blue, yellow, and green. Show clear fingerprints, slight sculpting marks, and a glossy, flexible texture typical of soft modeling clay. The background can include simple clay-built elements, like colorful shapes or playful props, evoking a cheerful, handcrafted style inspired by children's stop-motion animations and modeling clay creations.",
