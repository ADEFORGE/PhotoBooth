...
# --- Styles disponibles ---
dico_styles = {
    "clay": "A cheerful, cartoonish portrait of a person entirely sculpted from colorful modeling clay like Play-Doh, with extra rounded, soft, and bouncy shapes. Facial features are exaggerated, super smooth, and friendly, resembling toy-like characters with big eyes and simple expressions. Use vibrant, saturated colors — bright red, blue, yellow, green, pink, and purple — applied in fun, bold patches. Surfaces are glossy and slightly uneven, with visible fingerprints adding a handmade charm. The background features playful clay elements like rainbows, stars, clouds, or simple blobs, enhancing the whimsical, round, child-friendly look inspired by animated clay figures and children's cartoons.",
