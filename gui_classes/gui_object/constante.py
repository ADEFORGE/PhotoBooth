...
# --- Styles disponibles ---
dico_styles = {
    "clay": "A highly stylized, cartoonish portrait of a person designed to look like a plastic toy character from an animated movie like Toy Story. Emphasize ultra-round, smooth shapes with exaggerated, friendly facial features and shiny, polished plastic textures. Use vibrant, saturated colors—bold reds, blues, yellows, greens, and playful tones—combined with a soft, high-gloss finish typical of toy figurines. Facial details like eyes and mouth are large and expressive, resembling collectible action figures or animated dolls. The background can feature a toy shelf, a child's bedroom, or oversized playful props, enhancing the fun, toy-like, Pixar-inspired aesthetic.",
