...
# --- Styles disponibles ---
dico_styles = {
    "clay": "A playful portrait of a person crafted entirely from colorful modeling clay or plasticine, with soft, rounded shapes and hand-sculpted textures. Emphasize exaggerated, cartoon-like facial features, smooth but slightly imperfect surfaces showing fingerprints or sculpting marks. Use bold, vibrant colors and simplified forms, with a charming, handmade appearance. The background can feature a clay-built landscape or simple textured backdrop, evoking a whimsical, stop-motion animation style inspired by works like Wallace & Gromit or Claymation films.",
