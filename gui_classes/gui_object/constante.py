...
# --- Styles disponibles ---
dico_styles = {
    "clay": "A fun, cartoonish 3D portrait of a person reimagined as a plastic toy character, with ultra-rounded, smooth shapes and shiny, polished textures, inspired by animated films like Toy Story. The person has exaggerated, friendly facial features, large expressive eyes, and a playful smile. The character wears a colorful accessory such as a pirate bandana, an oversized cowboy hat, or a shiny astronaut helmet, enhancing the toy-like look. Use a bright, saturated color palette dominated by bold yellows, blues, and reds, with glossy plastic finishes. The background features a playful toy room or a shelf with oversized objects, emphasizing the joyful, collectible toy aesthetic.",
