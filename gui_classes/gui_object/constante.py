...
dico_styles = {
    ...
    #"gothic": "Turn this person into a gothic character with dark, moody colors, dramatic lighting, and Victorian-inspired fashion. Use rich textures like velvet and lace, with accessories like chokers, corsets, and intricate jewelry. The background should be a dark, atmospheric setting with gothic architecture, candlelight, and shadowy figures.",
    ...
    #"minecraft": "Transform this person into a Minecraft character. Use blocky, pixelated features and bright, primary colors. Emphasize the cubic style of Minecraft with simple shapes and textures. The background should be a Minecraft landscape with blocky trees, grass, and structures like houses or castles.",
