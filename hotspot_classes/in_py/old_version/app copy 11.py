...
class HotspotShareImage:
    ...
    def update_splash_html(self) -> None:
        ...
        content = re.sub(
            ...
            f'<meta http-equiv="refresh" content="5;url=/{self.image}"',
            content
        )
...
<div style="text-align:center;margin-top:20px;">
  ...
  <p>
    <a href="http://192.168.5.1/{self.image}" target="_blank" rel="noopener noreferrer">
      iOS  « Tap & Hold »
    </a>
  </p>

  <p>
    <a href="http://192.168.5.1/{self.image}" download>
       Android et Desktop
    </a>
  </p>

  <p style="margin-top:20px; font-size:0.9em; color:#555;">
    Si rien ne se passe, rendez-vous sur 
    <a href="https://neverssl.com" target="_blank">neverssl.com</a>
  </p>


  <img src="/{self.image}" alt="Shared image" style="max-width:100%;height:auto;" type="image/png">
 <img src="/{self.image}" alt="Shared image" style="max-width:100%;height:auto;user-select: none;">
