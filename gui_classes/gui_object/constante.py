...
dico_styles = {
    ...
    "oil paint": "A portrait of a person in the style of a bold, expressive oil painting, with highly visible, textured brush strokes and exaggerated forms emphasizing facial structure. The painting features rich, layered oil textures, thick impasto details, and a warm, dramatic color palette. The composition reflects a classic, old master aesthetic, but with more pronounced painterly gestures and artistic interpretation. Visible canvas texture enhances the hand-painted, traditional look. Inspired by the expressive techniques of classical and post-impressionist oil painting, where brushwork and artistic style are intentionally prominent.",
