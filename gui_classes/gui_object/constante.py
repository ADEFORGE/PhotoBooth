...
dico_styles = {
    ...
    "oil paint": "A portrait of a person in the style of a traditional oil painting, with soft, natural lighting and smooth, controlled brush strokes. The textures remain elegant and subtle, but the facial forms and structures are more defined, with pronounced contours, bold light and shadow contrasts, and sculpted features that emphasize depth and dimension. The warm color palette and classic painterly aesthetic are preserved, along with the visible canvas texture, creating a timeless yet artistically strong composition inspired by old master techniques.",
