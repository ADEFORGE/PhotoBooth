...
# --- Styles disponibles ---
dico_styles = {
    "clay": "A playful, cartoonish 3D portrait of a person designed to look like a plastic toy character from an animated movie like Toy Story. Emphasize ultra-rounded, smooth shapes with exaggerated, friendly facial features and a high-gloss, polished plastic texture. Use a bright, saturated color palette dominated by bold yellows, blues, and reds, creating a vibrant, toy-like appearance. The character has large, expressive eyes and simplified, fun proportions. The background features a playful, oversized environment such as a toy shelf or a colorful playroom, enhancing the joyful, collectible figure aesthetic.",
