...
# --- Styles disponibles ---
dico_styles = {
    "clay": "A playful, ultra-colorful portrait of a person made entirely from soft, bright modeling clay like Play-Doh, with rounded, cartoon-like shapes and a smooth, glossy finish. Use bold, saturated colors such as bright red, yellow, blue, green, and pink, arranged in a fun, childlike style. The facial features are simple, exaggerated, and friendly, with visible fingerprints and soft sculpting details that enhance the handmade, playful look. Include a cheerful background made of colorful clay elements—stars, clouds, flowers, or simple geometric shapes—resembling a toy-like, fun environment inspired by children's modeling clay creations.",
